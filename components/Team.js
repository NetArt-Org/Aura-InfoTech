    ...
    return (
      ...
      <a href=""><i className={`bi bi-instagram`}></i></a> */}
                        ...
                        <div className={`col-lg-4 col-md-6 d-flex align-items-stretch ${styles["justify-center"]}`} data-aos="fade-up" data-aos-delay="200">
                            <div className={styles["team-member"]}>
                                <div className={styles["member-img"]}>
                                    <img src="./img/team/coo.jpeg" className={styles["team-img-fluid"]} alt="" />
                                    <div className={styles.social}>
                                        {/* <a href=""><i className={`bi bi-twitter-x`}></i></a>
      <a href=""><i className={`bi bi-facebook`}></i></a>
      <a href=""><i className={`bi bi-instagram`}></i></a> */}
                                        <a href="https://www.linkedin.com/in/poongunran-s-87117424" target='_blank'><i className={`bi bi-linkedin`}></i></a>
                                    </div>
                                </div>
                                <div className={styles["member-info"]}>
